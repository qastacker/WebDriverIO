...
class AllureReporter extends _reporter.default {
  ...
  onBeforeCommand(command) {
    ...
    this.allure.startStep(command.method ? `${command.method} ${command.endpoint}` : command.command);
  ...
  isScreenshotCommand(command) {
    ...
    return isScrenshotEndpoint.test(command.endpoint) || command.command === 'takeScreenshot';
  }
